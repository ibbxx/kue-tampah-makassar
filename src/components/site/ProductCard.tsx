  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <button
          className="group flex w-full flex-col overflow-hidden rounded-2xl border border-border bg-card text-left transition hover:-translate-y-1 hover:shadow-lg focus:outline-none"
        >
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          ...
          <p className="text-sm text-foreground/80 leading-relaxed">
            {product.description ?? "Berisi aneka kue tradisional terbaik dengan bahan berkualitas dan cita rasa autentik."}
          </p>
